#  https://github.com/Microsoft/vsts-rm-documentation/tree/master/WinRM
...
$helpMsg = "Usage:
            To configure WinRM over Https:
                ./windows-configurewinrm.ps1 <fqdn\ipaddress> https

            To configure WinRM over Http:
                ./windows-configurewinrm.ps1 <fqdn\ipaddress> http"
...
function Configure-WinRMHttpsListener
{
    ...
    # Configure WinRM
    #cmd.exe /c $PSScriptRoot\winrmconf.cmd $hostname $thumbprint
...
{
    Write-Warning "Invalid Argument exception: '$hostname'"
    Write-Host $helpMsg
